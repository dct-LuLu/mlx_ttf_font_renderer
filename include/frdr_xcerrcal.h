...
/*   Updated: 2025/12/23 20:48:29 by jaubry--         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
supported currently"
# define FRDR_E_MSG_SUBTABLE "Error while reading and parsing .ttf \
subtables"
...
# define FRDR_E_MSG_SUBSTRUCT "Initialization of subtables structures \
failed"
...
# define FRDR_E_MSG_MTABLE "Invalid font offset table values, file may \
be corrupted"
# define FRDR_E_MSG_SFNT "Invalid sfnt version, font isn't in a TTF \
format or file may be corrupted\nFound sfnt version %d, expected %d"

# define FRDR_E_MSG_TAG "All mandatory tables were not found properly\
, file may be incompatible or corrupted"
# define FRDR_E_MSG_ENTRIES "Failed to correctly determine all table \
entries"

# define FRDR_E_MSG_OFFSET "Could not get %s offset"

# define FRDR_E_MSG_FCMAP "Invalid CMAP format, file may be \
incompatible\nFound %d expected %d"

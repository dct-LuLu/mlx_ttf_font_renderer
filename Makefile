...
SRCS		= main.c parser_font_ttf.c \
			  ...
			  text_rendering.c \
			  render_subpixel_antialiasing.c render_contour.c render_bounding_box.c add_text.c draw_routine.c \
			  parser_tag_utils.c \
			  init_utils.c \
			  ...
			  error_handler.c \
			  draw_routine.c \
			  img_utils.c mlx_draw_utils1.c mlx_draw_utils2.c mlx_font_renderer.c mlx_draw_curves.c \

...
void	ft_mlx_batch_put(t_img_data *img, t_vec2i pos, t_vec2i size, int color)
{
	int				x;
	int				y;
	int				offset;
...
*/
/*
void	ft_mlx_pixel_put(t_img_data *img, t_vec2i pos, int color)
{
	int				offset;
	unsigned int	*pixel;
...
*/
static t_line	get_line_data(t_vec2i a, t_vec2i b)
{
	t_line	line;
...
*/
void	ft_mlx_line_put(t_img_data *img, t_vec2i a, t_vec2i b, int color)
{
	t_line	line;

...
/*   Updated: 2025/05/28 02:24:48 by jaubry--         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
static void	get_transformed_bounds(t_glyf_header *header,
		t_glyf_component *comp, t_vec2 *min, t_vec2 *max)
{
	t_vec2	corners[4];
	t_vec2	transformed;
	int		i;
 ...
 */
void	draw_transformed_bounding_box(t_env *env, t_glyf_header *header,
		t_vec2 pos, int color, t_glyf_component *comp)
{
	t_vec2 min, max;
	t_vec2 lb, rb, lt, rt;
